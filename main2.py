...
args = ArgumentParser()
args.add_argument("--dataset", type=str, default="bcb")
...
args.add_argument("--embedding_model", type=str, default="jinaai/jina-embeddings-v2-small-en")
...
encoder = SentenceTransformer(args.embedding_model, trust_remote_code=True, device="cpu")
...
if args.dataset == "bcb":
    ...
    if not driver.collection_exists(collection_name):
        ...
        ingest_data(driver, final, encoder, collection_name, 8)
    ...
    batches = create_batches(dataset, 8)
